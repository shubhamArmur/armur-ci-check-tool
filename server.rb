require 'git'           # Use the Git Ruby library to clone a repository
...
class GHAapp < Sinatra::Application
  ...
  post '/event_handler' do
    ...
    when 'check_suite'
      ...
      # check_suite events are : requested, rerequested, completed
  ...
  helpers do
    ...
    def initiate_check_run
      ...
      annotations = []
      # You can create a maximum of 50 annotations per request to the checks API.
      # To add more than 50 annotations, use the "Update a check run" API endpoint.
      # This example code limits the number of annotations to 50
      ...
      # ADD CODE HERE TO UPDATE CHECK RUN SUMARRY #
      # Update check run summary and text parameter
    ...
    # updates the contents using Git pull, and checks out the ref
    #
    # full_repo_name - The owner and repo. Ex: octocat/hello-world
    # repository     - The repository name
    # ref            - The branch or commit SHA or tag to check out
    ...
    def take_requested_action
      ...
      if(@payload['requested_action']['identifier'] == 'fix_rubocop_notices')
        ...
        # Automatically corrent RuboCop style errors
